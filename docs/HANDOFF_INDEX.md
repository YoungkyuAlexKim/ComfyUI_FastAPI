...
2026-08-13 Game UI 확장 및 그룹 수명주기 작업 기준으로 전체 테스트 105개가 통과했습니다. 묶음 저장은
...
파생본 64개, 그룹 단위 선택·삭제·복구와 새로고침을 확인했습니다. 셀 단위 삭제 요청도
서버에서 전체 그룹으로 승격되고, 영구 비우기는 ZIP·원본 시트·파생본까지 함께 제거합니다. 실서버 4×4 생성 후
