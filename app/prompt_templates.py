...
PROMPT_TEMPLATES: Dict[str, List[PromptTemplate]] = {
    ...
    "AceStep15XL": [
        ...
        {"title": "🔥 힙합/트랩", "tier": 1,
         "text": "Hard-hitting 808 bass with rapid hi-hat rolls and a dark, sparse trap beat. Distorted synth textures and eerie vocal chops create atmosphere. Heavy bass drops with aggressive snare patterns and reverb-soaked ad-libs."},
        {"title": "🌆 신스웨이브", "tier": 1,
